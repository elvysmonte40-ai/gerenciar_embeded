...
function DepartmentList() {
  ...
  const fetchDepartments = async () => {
    try {
      ...
      const { data, error: error2 } = await supabase.from("departments").select("*, creator:profiles!created_by(full_name)").eq("organization_id", orgId).order("name");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const orgId = session.user.user_metadata.organization_id;
      if (editingDept) {
        const { error: error2 } = await supabase.from("departments").update({ name, description }).eq("id", editingDept.id);
        if (error2) throw error2;
      } else {
        const { error: error2 } = await supabase.from("departments").insert({
  ...
  const handleToggleStatus = async (dept) => {
    ...
    try {
      const { error: error2 } = await supabase.from("departments").update({ is_active: !dept.is_active }).eq("id", dept.id);
      if (error2) throw error2;
      fetchDepartments();
    } catch (err) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-lg font-medium text-gray-900", children: "Departamentos" }),
      /* @__PURE__ */ jsx(
        "button",
        {
          onClick: () => {
    ...
    /* @__PURE__ */ jsx("div", { className: "bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "min-w-full divide-y divide-gray-200", children: [
      ...
      /* @__PURE__ */ jsxs("tbody", { className: "bg-white divide-y divide-gray-200", children: [
        departments.length === 0 && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: 5, className: "px-6 py-12 text-center text-gray-500", children: "Nenhum departamento cadastrado." }) }),
        departments.map((dept) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50 transition-colors group", children: [
          /* @__PURE__ */ jsx("td", { className: "px-6 py-4 whitespace-nowrap", children: /* @__PURE__ */ jsx("div", { className: "text-sm font-medium text-brand", children: dept.name }) }),
          /* @__PURE__ */ jsx("td", { className: "px-6 py-4 whitespace-nowrap", children: /* @__PURE__ */ jsx("span", { className: `px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${dept.is_active ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`, children: dept.is_active ? "Ativo" : "Inativo" }) }),
          /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsx("div", { className: "text-sm text-gray-500 line-clamp-2", children: dept.description }) }),
          /* @__PURE__ */ jsxs("td", { className: "px-6 py-4 whitespace-nowrap", children: [
            /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-900", children: new Date(dept.created_at).toLocaleDateString("pt-BR") }),
            /* @__PURE__ */ jsx("div", { className: "text-xs text-gray-500", children: dept.creator?.full_name || "-" })
          ] }),
    ...
    isModalOpen && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 overflow-y-auto", "aria-labelledby": "modal-title", role: "dialog", "aria-modal": "true", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full", children: /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-lg leading-6 font-medium text-gray-900", id: "modal-title", children: editingDept ? "Editar Departamento" : "Novo Departamento" }),
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "AppLayout", $$AppLayout, { "title": "Gerenciar - Departamentos" }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8"> ${renderComponent($$result2, "DepartmentList", DepartmentList, { "client:load": true, "client:component-hydration": "load", "client:component-path": "D:/OneDrive/TatuTec/gerenciar/src/modules/admin/departments/components/DepartmentList", "client:component-export": "default" })} </div> `, "sidebar": ($$result2) => renderTemplate`${renderComponent($$result2, "AdminSidebar", $$AdminSidebar, { "slot": "sidebar" })}` })}`;
}, "D:/OneDrive/TatuTec/gerenciar/src/pages/admin/departments/index.astro", void 0);

const $$file = "D:/OneDrive/TatuTec/gerenciar/src/pages/admin/departments/index.astro";
