          ...
          <tr>
            <td style="padding:24px 40px;background-color:#f7f8fa;border-top:1px solid #edf2f7;text-align:center;">
              <p style="margin:0;font-size:12px;color:${mutedColor};">
                © ${(/* @__PURE__ */ new Date()).getFullYear()} Gerenciar by Tatutec. Todos os direitos reservados.
              </p>
...
function welcomeEmailTemplate(fullName) {
...
function passwordResetEmailTemplate(resetUrl) {
  const content = `
    <h1 style="margin:0 0 16px;font-size:24px;font-weight:700;color:${textColor};">
      Redefinir sua senha 🔐
    </h1>
...
export { passwordResetEmailTemplate as p, welcomeEmailTemplate as w };
