-- Create the process_viewer_roles junction table
CREATE TABLE IF NOT EXISTS public.process_viewer_roles (
...
-- Enable RLS
ALTER TABLE public.process_viewer_roles ENABLE ROW LEVEL SECURITY;

-- Policies
CREATE POLICY "Enable read access for all authenticated users in the organization" 
ON public.process_viewer_roles 
FOR SELECT 
